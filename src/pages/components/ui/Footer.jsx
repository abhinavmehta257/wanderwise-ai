...
const Footer = () => {
    return (
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="https://www.instagram.com/wanderwise_ai/" class="hover:underline ">Instagram</a>
                        </li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">Wanderwise</a>. All Rights Reserved.
            </span>
        </div>
        </div>
    </footer>
